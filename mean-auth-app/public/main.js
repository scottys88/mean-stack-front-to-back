...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_13__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_16__["AuthService"]],
...
module.exports = "<div class=\"jumbotron text-center\">\r\n  <h1>Mean Authentication</h1>\r\n  <p class=\"lead\">Mean Authentication App</p>\r\n  <div>\r\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a>\r\n    &nbsp; <a class=\"btn btn-primary\" [routerLink]=\"['/login']\">Login</a>    \r\n  </div>\r\n</div>\r\n\r\n<div class=\"row\">\r\n  <div class=\"col-md-4\">\r\n    <h3>Express Backend</h3>\r\n    <p>Irure nisi anim duis aute qui voluptate aliquip Lorem Lorem commodo. Non culpa aute quis ipsum aliqua fugiat dolore culpa fugiat consectetur quis. Dolor nostrud tempor elit amet commodo voluptate velit do mollit. Ut minim enim ipsum qui adipisicing incididunt in sint. Reprehenderit id culpa ullamco sint labore tempor sit amet eu ullamco. Occaecat aute anim dolor minim dolor veniam eu minim excepteur aliquip laborum.</p>\r\n  </div>\r\n  <div class=\"col-md-4\">\r\n    <h3>Express Backend</h3>\r\n    <p>Irure nisi anim duis aute qui voluptate aliquip Lorem Lorem commodo. Non culpa aute quis ipsum aliqua fugiat dolore culpa fugiat consectetur quis. Dolor nostrud tempor elit amet commodo voluptate velit do mollit. Ut minim enim ipsum qui adipisicing incididunt in sint. Reprehenderit id culpa ullamco sint labore tempor sit amet eu ullamco. Occaecat aute anim dolor minim dolor veniam eu minim excepteur aliquip laborum.</p>\r\n  </div>\r\n  <div class=\"col-md-4\">\r\n    <h3>Express Backend</h3>\r\n    <p>Irure nisi anim duis aute qui voluptate aliquip Lorem Lorem commodo. Non culpa aute quis ipsum aliqua fugiat dolore culpa fugiat consectetur quis. Dolor nostrud tempor elit amet commodo voluptate velit do mollit. Ut minim enim ipsum qui adipisicing incididunt in sint. Reprehenderit id culpa ullamco sint labore tempor sit amet eu ullamco. Occaecat aute anim dolor minim dolor veniam eu minim excepteur aliquip laborum.</p>\r\n  </div>\r\n</div>\r\n"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onLoginSubmit = function (formValues) {
        var _this = this;
        this.loginCreds = formValues.value;
        console.log(this.loginCreds);
        this.authService.authenticateUser(this.loginCreds).subscribe(function (data) {
            console.log(data);
            if (data.success) {
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function (e) {
        var _this = this;
        var formValues = e.value;
        this.user = {
        ...
        this.authService.registerUser(this.user).subscribe(function (data) {
            if (data) {
                ...
                _this.flashMessages.show('Somethign went wrong', { cssClass: 'alert-danger' });
            }
        });
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.authenticateUser = function (userLogin) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.append('Content-type', 'application/json');
        return this.http.post("users/authenticate", userLogin, { headers: headers });
    };
    ...
    AuthService.prototype.storeUserData = function (serverResponse) {
...
module.exports = __webpack_require__(/*! C:\Users\scott\OneDrive\Documents\sites\mean-stack-front-to-back\mean-auth-app\angular-src\src\main.ts */"./src/main.ts");
